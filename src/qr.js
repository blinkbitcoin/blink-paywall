...
// Minified, UMD footer stripped, re-exported as an ES module (unchanged
// otherwise). The word "QR Code" is a registered trademark of DENSO WAVE
// INCORPORATED.
//-------------------------------------------------------------------------
...
var qrcode = (function () {
    var t = function (t, r) {
        var e = t,
            ...
            w = function (t, r) {
                for (
                    var e = -1, n = i - 1, a = 7, u = 0, f = B.getMaskFunction(r), g = i - 1;
                    g > 0;
                    g -= 2
                )
                    for (6 == g && (g -= 1); ;) {
            ...
            y = function (t, r, e) {
                ...
                return (function (t, r) {
                    for (
                        ...
                        e += f;
                        var l = B.getErrorCorrectPolynomial(g),
                            h = C(i[u], l.getLength() - 1).mod(l);
                        for (a[u] = new Array(l.getLength() - 1), c = 0; c < a[u].length; c += 1) {
                            var s = c + h.getLength() - a[u].length;
                            a[u][c] = s >= 0 ? h.getAt(s) : 0;
                        }
                    }
                    var v = 0;
                    for (c = 0; c < r.length; c += 1) v += r[c].totalCount;
                    var d = new Array(v),
                        w = 0;
                    for (c = 0; c < n; c += 1)
                        for (u = 0; u < r.length; u += 1)
                            c < i[u].length && ((d[w] = i[u][c]), (w += 1));
                    for (c = 0; c < o; c += 1)
                        for (u = 0; u < r.length; u += 1)
                            c < a[u].length && ((d[w] = a[u][c]), (w += 1));
                    return d;
                })(o, n);
            };
        ((f.addData = function (t, r) {
            ...
            (f.createSvgTag = function (t, r, e, n) {
                ...
                var i,
                    ...
                    u,
                    g,
                    c = f.getModuleCount() * t + 2 * r,
                    l = '';
                for (
                    g = 'l' + t + ',0 0,' + t + ' -' + t + ',0 0,-' + t + 'z ',
                        l += '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"',
                        l += o.scalable ? '' : ' width="' + c + 'px" height="' + c + 'px"',
                        l += ' viewBox="0 0 ' + c + ' ' + c + '" ',
                        ...
                        l +=
                            n.text || e.text
                                ...
                                : '',
                        l += '>',
                        l += n.text ? '<title id="' + p(n.id) + '">' + p(n.text) + '</title>' : '',
                        l += e.text
                            ? '<description id="' + p(e.id) + '">' + p(e.text) + '</description>'
                            : '',
            ...
            (f.createASCII = function (t, r) {
                if ((t = t || 1) < 2)
                    return (function (t) {
                        ...
                        for (r = 0; r < a; r += 2) {
                            for (
                                n = Math.floor((r - u) / 1), o = Math.floor((r + 1 - u) / 1), e = 0;
                                e < a;
                                e += 1
                            )
                                ((i = '█'),
                ...
                for (o = 0; o < r; o += 1)
                    for (n = 0; n < r - 6; n += 1)
                        t.isDark(n, o) &&
                            ...
                            (e += 40);
                var c = 0;
                for (o = 0; o < r; o += 1) for (n = 0; n < r; n += 1) t.isDark(n, o) && (c += 1);
                ...
                multiply: function (t) {
                    for (
                        ...
                        for (var o = 0; o < t.getLength(); o += 1)
                            r[e + o] ^= k.gexp(k.glog(n.getAt(e)) + k.glog(t.getAt(o)));
                    return C(r, 0);
                },
                mod: function (t) {
                    if (n.getLength() - t.getLength() < 0) return n;
                    for (
                        var r = k.glog(n.getAt(0)) - k.glog(t.getAt(0)),
            ...
            return (
                (e.getRSBlocks = function (e, n) {
                    ...
                    for (var i = o.length / 3, a = [], u = 0; u < i; u += 1)
                        for (
                            var f = o[3 * u + 0], g = o[3 * u + 1], l = o[3 * u + 2], h = 0;
                            h < f;
                            h += 1
                        )
                            a.push(r(g, l));
